  ...
  <div class="min-h-screen flex flex-col bg-slate-950 text-slate-100 selection:bg-blue-600 selection:text-white">
    ...
    <div class="flex-1 flex flex-col md:flex-row">
      ...
      <aside
        ...
        class="w-full md:w-64 bg-slate-900 border-b md:border-b-0 md:border-r border-slate-800 flex flex-col shrink-0"
      >
        ...
        <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
          ...
          >
            <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 18.782V8.018a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
            </svg>
        ...
        <div class="p-4 border-t border-slate-800 bg-slate-900/50 flex items-center justify-between">
          <div class="truncate">
            ...
            <p class="text-[10px] text-slate-400 capitalize">
              Area:
              <span class="text-slate-200 font-medium">{{ auth.assignedArea }}</span>
              •
              <span class="text-slate-400">{{ auth.userRole }}</span>
            </p>
          </div>
      ...
      <main
        :class="[
          ...
          route.name === 'admin-login' ? '' : 'p-4 md:p-6'
        ]"
      >
        <router-view />
      </main>
