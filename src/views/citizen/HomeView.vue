  ...
  <div class="space-y-4">
    ...
    <div class="p-4 rounded-xl bg-slate-800 border border-slate-700 shadow-md">
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs uppercase font-bold tracking-wider text-slate-400">Current Weather Alert</span>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="text-right">
          ...
          <p class="text-[11px] text-slate-400">Rainfall Rate</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 rounded-xl bg-slate-800 border border-slate-700 shadow-md space-y-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
          ...
          <div>
            <h3 class="font-bold text-sm text-white">Current Location</h3>
            <p class="text-[11px] text-slate-400">IndexedDB Cached GPS</p>
          </div>
        </div>
      ...
      <div v-else class="text-xs text-slate-400 p-2 text-center">
        No cached location available yet. Press "Refresh My Location" to save.
      </div>
    </div>
    ...
    <div class="p-5 rounded-xl bg-gradient-to-br from-red-950/80 to-slate-900 border border-red-800/60 shadow-lg text-center space-y-3">
      <h3 class="text-lg font-extrabold text-white">Emergency Assistance</h3>
      <p class="text-xs text-slate-300">
        Press the button below to request immediate CDRRMO emergency response. Works offline and on degraded signals.
      </p>
      <router-link
        to="/app/sos"
    ...
    <div class="grid grid-cols-2 gap-3">
      ...
      >
        ...
        <div>
          <h4 class="font-bold text-sm text-white">Evacuation Routes</h4>
          <p class="text-[11px] text-slate-400 mt-0.5">Flow Engine predictive safe paths</p>
        </div>
      </router-link>
      ...
      >
        ...
        <div>
          <h4 class="font-bold text-sm text-white">Disaster Guides</h4>
          <p class="text-[11px] text-slate-400 mt-0.5">Offline response SOPs & checklists</p>
        </div>
      </router-link>
      ...
      >
        ...
        <div>
          <h4 class="font-bold text-sm text-white">Flow Engine</h4>
          <p class="text-[11px] text-slate-400 mt-0.5">Rainfall risk & route status</p>
        </div>
      </router-link>
    </div>
  </div>
