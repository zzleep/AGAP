<template>
  <div class="space-y-3">
    <!-- Time-of-Day Greeting (Page H1) + Muted Date Line -->
    <div class="pt-0.5">
      <h1 class="font-expressive text-2xl font-black tracking-tight text-[#0A0A0A]">{{ greeting }}</h1>
      <p class="mt-0.5 text-xs font-medium text-[#717171]">{{ todayDate }}</p>
    </div>
